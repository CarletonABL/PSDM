classdef DensoAlt5NoOpt < SerialManipulator & ...
                   handle
    ...
    properties (Constant)
        ...
        nominalPose = deg2rad([0 0 90 0 90]');
    ...
    properties (Hidden, Constant)
        ...
        m = [7.6; 2.8; 7; 2.9; 0.94];
        
        % rc
        rc = [-0.0376,     0.1554      0.045       -0.001       0.0001;
              0.0435,      -0.0062      -0.007      0.1021      -0.03;
              -0.0076,     0.1148       0.004       -0.0028     0.0106];
    ...
    methods
        ...
        % Constructor
        %=================================================================%
        function Robot = DensoAlt5NoOpt(varargin)
